...
type Api struct {
	...
	Group       int    `gorm:"column:group;comment:分组" json:"group" binding:"required"`
	NoForensics bool   `gorm:"column:no_forensics;type:boolean;comment:不鉴权" json:"no_forensics"`
